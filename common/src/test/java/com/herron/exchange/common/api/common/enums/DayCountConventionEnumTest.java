...
class DayCountConventionEnumTest {

    @Test
    void test_bond_basis_30360() {
        var convention = DayCountConventionEnum.BOND_BASIS_30360;
    ...
    void test_bond_basis_act_365() {
        var convention = DayCountConventionEnum.ACT365;
        LocalDate startDate = LocalDate.of(2023, 1, 1);
        LocalDate endEnd = LocalDate.of(2023, 2, 28);
    ...
    void test_bond_basis_act_360() {
        var convention = DayCountConventionEnum.ACT360;
        LocalDate startDate = LocalDate.of(2023, 1, 1);
        LocalDate endEnd = LocalDate.of(2023, 2, 28);
